...
def community(rquest):
    return render(rquest, 'community.html')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            try:
                ...
                return redirect('user:community_join')
    ...
    try:
        ...
        faqs = [
            ...
            },
            {
                ...
                'answer': 'Yes, we use end-to-end encryption and decentralized storage to ensure your data reusers private and secure.'
            }
        ]
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                return redirect('user:register_device')
            except Exception as e:
...
def ask_question(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('user:question_detail', slug=question.slug)
    else:
        form = QuestionForm()
...
def post_answer(request, slug):
    ...
    return redirect('user:question_detail', slug=slug)
